...
! function(t, e) {
    ...
    return function(t) {
        ...
        e.Date = function() {
            function t(e) {
                if (function(t, e) {
                    ...
                    var i = this,
                        n = i.$(e.el);
                    if (n && !n.rolldate && (n.rolldate = !0, i.extend(e), n.addEventListener("click", function() {
            ...
            return o(t, [{
                ...
                value: function(t) {
                    ...
                    for (var i in e)
                        if (e[i] && "object" == n(e[i]))
                            for (var o in t[i]) e[i][o] = null == t[i][o] ? e[i][o] : t[i][o];
                ...
                key: "createUi",
                value: function() {
                    for (var t = this, e = t.baseData(), i = e.dateFormat.indexOf(t.config.format), n = 5 == (i = i > 1 ? i + 1 : i) ? [e.domClass[0]] : 6 == i ? [e.domClass[1]] : 7 == i ? [e.domClass[2]] : 8 == i ? e.domClass.slice(3, 5) : 9 == i ? e.domClass.slice(3) : 10 == i ? e.domClass.slice(0, 4) : 11 == i ? e.domClass.slice(3, 4) : 12 == i ? e.domClass.slice(4, 5) : 13 == i ? e.domClass.slice(5, 6) : e.domClass.slice(0, i + 2), o = n.length, s = "", r = t.$(t.config.el).date || e.date, l = t.config.lang, h = 0; h < o; h++) {
                        s += '<div id="' + n[h] + '"><ul class="wheel-scroll">';
                        var c = 0;
                        if (0 == h && (i < 6 || 10 == i))
                            for (var p = t.config.beginYear; p <= t.config.endYear; p++) s += '<li class="wheel-item ' + (p == r.getFullYear() ? "active" : "") + '" data-index="' + c + '">' + p + l.year + "</li>", c++;
                        else if (1 != h && 6 != i || !(i < 7 || 10 == i))
                            if (2 != h && 7 != i || !(i <= 7 || 10 == i)) {
                                if (3 == h || i > 7 && i < 12 && 0 == h)
                                    for (var d = 0; d <= 23; d++) s += '<li class="wheel-item ' + (d == r.getHours() ? "active" : "") + '" data-index="' + c + '">' + (d < 10 ? "0" + d : d) + l.hour + "</li>", c++;
                                else if (4 == h || i > 7 && 1 == h || 12 == i)
                                    for (var u = 0; u <= 59; u += t.config.minStep) s += '<li class="wheel-item ' + (u == r.getMinutes() ? "active" : "") + '" data-index="' + c + '">' + (u < 10 ? "0" + u : u) + l.min + "</li>", c++;
                                else if (5 == h || i > 7 && 2 == h || 13 == i)
                                    for (var f = 0; f <= 59; f++) s += '<li class="wheel-item ' + (f == r.getSeconds() ? "active" : "") + '" data-index="' + c + '">' + (f < 10 ? "0" + f : f) + l.sec + "</li>", c++
                            } else
                                for (var m = t.bissextile(r.getFullYear(), r.getMonth() + 1), v = 1; v <= m; v++) s += '<li class="wheel-item ' + (v == r.getDate() ? "active" : "") + '" data-index="' + c + '">' + (v < 10 ? "0" + v : v) + l.day + "</li>", c++;
                        else
                            for (var g = 1; g <= 12; g++) s += '<li class="wheel-item ' + (g == r.getMonth() + 1 ? "active" : "") + '" data-index="' + c + '">' + (g < 10 ? "0" + g : g) + l.month + "</li>", c++;
                        s += "</ul></div>"
                    }
                    ...
                    b.className = "rolldate-container" + (navigator.userAgent.match(/MicroMessenger/i) ? " wx" : ""), b.innerHTML = y, document.body.appendChild(b), t.scroll = [];
                    for (var w = function(i) {
                            t.scroll[i] = new a.default("#" + n[i], {
                                wheel: {
                                    selectedIndex: 0,
                            ...
                            o.wheelTo(h), o.on("scrollEnd", function() {
                                if (t.config.moveEnd && t.config.moveEnd.call(t, t.$(t.config.el), o), -1 != e.domClass.slice(0, 2).indexOf(o.wrapper.id) && t.scroll[2]) {
                                    ...
                                    if (i != t.$("#" + e.domClass[2] + " li", "all").length) {
                                        ...
                                        t.$("#" + e.domClass[2] + " ul").innerHTML = n, t.scroll[2].refresh()
                                    }
                                }
                            })
                        }, x = 0; x < o; x++) w(x);
                    ...
                    e.addEventListener("click", function() {
                        ...
                        if (t.scroll.forEach(function(e, i) {
                                var r = t.getscrollDay(e),
                                    a = void 0;
                                s <= 4 || 9 == s ? a = 0 == i ? "YYYY" : 1 == i ? "MM" : 2 == i ? "DD" : 3 == i ? "hh" : 4 == i ? "mm" : "ss" : 5 == s ? a = "MM" : 6 == s ? a = "DD" : 7 == s ? a = 0 == i ? "hh" : 1 == i ? "mm" : "" : 8 == s ? a = 0 == i ? "hh" : 1 == i ? "mm" : "ss" : 10 == s ? a = "hh" : 11 == s ? a = "mm" : 12 == s && (a = "ss"), n = n.replace(a, r), "YYYY" == a ? o.setFullYear(r) : "MM" == a ? o.setMonth(r - 1) : "DD" == a ? o.setDate(r) : "hh" == a ? o.setHours(r) : "mm" == a ? o.setMinutes(r) : "ss" == a && o.setSeconds(r)
                            }), t.config.confirmBefore) {
                            var r = t.config.confirmBefore.call(t, e, n);
                            if (!1 === r) return !1;
                            r && (n = r)
                        }
                        "input" == e.nodeName.toLowerCase() ? e.value = n : e.innerText = n, t.destroy(n), e.date = o
                    })
                }
            }, {
                key: "bissextile",
                value: function(t, e) {
                    var i = void 0;
                    return 1 == e || 3 == e || 5 == e || 7 == e || 8 == e || 10 == e || 12 == e ? i = 31 : 4 == e || 6 == e || 11 == e || 9 == e ? i = 30 : 2 == e && (i = t % 4 != 0 || t % 100 == 0 && t % 400 != 0 ? 28 : 29), i
                }
            }, {
                key: "destroy",
                value: function(t) {
                    ...
                    e.$(".rolldate-panel").className = "rolldate-panel fadeOut", setTimeout(function() {
        ...
        function y(t, e) {
            ...
            if (e.singleton) {
                var r = h++;
                i = l || (l = v(e)), n = x.bind(null, i, r, !1), o = x.bind(null, i, r, !0)
                ...
                (e.convertToAbsoluteUrls || s) && (n = p(n));
        ...
        "use strict";
        var n, o, s, r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            return typeof t
        } : function(t) {
            return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
        };
        s = function() {
            ...
            function k(t) {
                ...
                function l() {
                    (o = document.createEvent("Event")).initEvent(e, s, r), a(o, n)
                }
            ...
            function E(t, e, i, n, o, s, r) {
                var a = t - e,
                    ...
                    f = d ? 4 : 15,
                    m = t + l / h * (a < 0 ? -1 : 1);
                return d && c && (m = Math.round(m / c) * c), m < n ? (m = s ? Math.max(n - s / 4, n - s / f * l) : n, u = p) : o < m && (m = s ? Math.min(o + s / 4, o + s / f * l) : o, u = p), {
            ...
            function _() {}
            var X, O, L, C, I = i ? window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || function(t) {
                    return window.setTimeout(t, (t.interval || 100 / 60) / 2)
                } : _,
                P = i ? window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || function(t) {
            ...
            function H(t, e) {
                this.wrapper = "string" == typeof t ? document.querySelector(t) : t, this.wrapper || A("Can not resolve the wrapper DOM."), this.scroller = this.wrapper.children[0], this.scroller || A("The wrapper need at least one child element to be scroller."), this.scrollerStyle = this.scroller.style, this._init(e)
            }
            return (X = H).prototype._init = function(t) {
                ...
                this.lastScale = l(this.scale) ? t : this.scale, this.scale = t
                        ...
                        (function() {
                            if (!this.destroyed) {
                                var o = (t = S(this.scroller)).width,
                                    s = t.height;
                                e === o && i === s || this.refresh(), e = o, i = s, n.call(this)
                            }
                        }).call(o)
                    }, 1e3)
                }).call(this)
                ...
                n ? (this.items = this.scroller.children, this.options.itemHeight = this.itemHeight = this.items.length ? this.scrollerHeight / this.items.length : 0, void 0 === this.selectedIndex && (this.selectedIndex = n.selectedIndex || 0), this.options.startY = -this.selectedIndex * this.itemHeight, this.maxScrollX = 0, this.maxScrollY = -this.itemHeight * (this.items.length - 1)) : (this.maxScrollX = this.wrapperWidth - this.scrollerWidth, this.options.infinity || (this.maxScrollY = this.wrapperHeight - this.scrollerHeight), this.maxScrollX < 0 ? (this.maxScrollX -= this.relativeX, this.minScrollX = -this.relativeX) : 1 < this.scale && (this.maxScrollX = this.maxScrollX / 2 - this.relativeX, this.minScrollX = this.maxScrollX), this.maxScrollY < 0 ? (this.maxScrollY -= this.relativeY, this.minScrollY = -this.relativeY) : 1 < this.scale && (this.maxScrollY = this.maxScrollY / 2 - this.relativeY, this.minScrollY = this.maxScrollY)), this.hasHorizontalScroll = this.options.scrollX && this.maxScrollX < this.minScrollX, this.hasVerticalScroll = this.options.scrollY && this.maxScrollY < this.minScrollY, this.hasHorizontalScroll || (this.maxScrollX = this.minScrollX, this.scrollerWidth = this.wrapperWidth), this.hasVerticalScroll || (this.maxScrollY = this.minScrollY, this.scrollerHeight = this.wrapperHeight), this.endTime = 0, this.directionX = 0, this.directionY = 0, this.wrapperOffset = f(this.wrapper), this.trigger("refresh"), !this.scaled && this.resetPosition()
                ...
                if ((1 === e || 0 === t.button) && !(!this.enabled || this.destroyed || this.initiated && this.initiated !== e)) {
                    this.initiated = e, this.options.preventDefault && !Y(t.target, this.options.preventDefaultException) && t.preventDefault(), this.options.stopPropagation && t.stopPropagation(), this.moved = !1, this.distX = 0, this.distY = 0, this.directionX = 0, this.directionY = 0, this.movingDirectionX = 0, this.movingDirectionY = 0, this.directionLocked = 0, this._transitionTime(), this.startTime = r(), this.options.wheel && (this.target = t.target), this.stop();
                ...
                if (this.enabled && !this.destroyed && T[t.type] === this.initiated) {
                    ...
                    if (!(a - this.endTime > this.options.momentumLimitTime && s < this.options.momentumLimitDistance && o < this.options.momentumLimitDistance)) {
                        ...
                        i = this.hasHorizontalScroll ? i : 0, n = this.hasVerticalScroll ? n : 0, this.movingDirectionX = 0 < i ? -1 : i < 0 ? 1 : 0, this.movingDirectionY = 0 < n ? -1 : n < 0 ? 1 : 0;
                        var l = this.x + i,
                            h = this.y + n,
                            c = !1,
                            p = !1,
                ...
                if (this.enabled && !this.destroyed && T[t.type] === this.initiated) {
                    ...
                    var e = Math.round(this.x),
                        ...
                        n = e - this.absStartX,
                        o = i - this.absStartY;
                    if (this.directionX = 0 < n ? -1 : n < 0 ? 1 : 0, this.directionY = 0 < o ? -1 : o < 0 ? 1 : 0, !this.options.pullDownRefresh || !this._checkPullDown())
                        if (this._checkClick(t)) this.trigger("scrollCancel");
                        else if (!this.resetPosition(this.options.bounceTime, D.bounce)) {
                        this._translate(e, i), this.endTime = r();
                        ...
                        if (this._events.flick && s < this.options.flickLimitTime && a < this.options.flickLimitDistance && l < this.options.flickLimitDistance) this.trigger("flick");
                            ...
                            if (this.options.momentum && s < this.options.momentumLimitTime && (l > this.options.momentumLimitDistance || a > this.options.momentumLimitDistance)) {
                                var c = !1,
                                    ...
                                    u = !1,
                                    f = this.options.bounce;
                                !1 !== f && (c = void 0 === f.top || f.top, p = void 0 === f.bottom || f.bottom, d = void 0 === f.left || f.left, u = void 0 === f.right || f.right);
                                ...
                                e = g.destination, i = y.destination, h = Math.max(g.duration, y.duration), this.isInTransition = !0
                            ...
                            if (this.options.snap) {
                                ...
                                this.currentPage = w, h = this.options.snapSpeed || Math.max(Math.max(Math.min(Math.abs(e - w.x), 1e3), Math.min(Math.abs(i - w.y), 1e3)), 300), e = w.x, i = w.y, this.directionX = 0, this.directionY = 0, b = this.options.snap.easing || D.bounce
                            }
                            if (e !== this.x || i !== this.y) return (e > this.minScrollX || e < this.maxScrollX || i > this.minScrollY || i < this.maxScrollY) && (b = D.swipeBounce), void this.scrollTo(e, i, h, b);
                ...
                return this.options.tap && (e = t, i = this.options.tap, (n = document.createEvent("Event")).initEvent(i, !0, !0), n.pageX = e.pageX, n.pageY = e.pageY, e.target.dispatchEvent(n)), this.options.click && !Y(t.target, this.options.preventDefaultException) && k(t), this.lastClickTime = p ? null : r(), !0
                ...
                P(this.probeTimer), this.probeTimer = I(function e() {
                    var i = t.getComputedPosition();
                    t.trigger("scroll", i), t.isInTransition ? t.probeTimer = I(e) : t.trigger("scrollEnd", i)
                });
                var t = this
            }, O.prototype._transitionTime = function() {
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0;
                if (this.scrollerStyle[x.transitionDuration] = t + "ms", this.options.wheel)
                    for (var e = 0; e < this.items.length; e++) this.items[e].style[x.transitionDuration] = t + "ms";
                if (this.indicators)
                ...
                if (this.scrollerStyle[x.transitionTimingFunction] = t, this.options.wheel)
                    for (var e = 0; e < this.items.length; e++) this.items[e].style[x.transitionTimingFunction] = t;
                if (this.indicators)
                ...
                if (function(t, e) {
                    ...
                    }(!l(t) && !l(e)), l(i) && (i = this.scale), this.options.useTransform ? this.scrollerStyle[x.transform] = "translate(" + t + "px," + e + "px) scale(" + i + ")" + this.translateZ : (t = Math.round(t), e = Math.round(e), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = e + "px"), this.options.wheel)
                    for (var n = this.options.wheel.rotate, o = void 0 === n ? 25 : n, s = 0; s < this.items.length; s++) {
                ...
                var o = this,
                    ...
                    c = r(),
                    p = c + i;
                this.isAnimating = !0, P(this.animateTimer),
                    function d() {
                        var u = r();
                        if (p <= u) return o.isAnimating = !1, o._translate(t, e, h), o.trigger("scroll", {
                            x: o.x,
                            y: o.y
                        ...
                        var f = n(u = (u - c) / i),
                            ...
                            v = (e - a) * f + a,
                            g = (h - l) * f + l;
                        o._translate(m, v, g), o.isAnimating && (o.animateTimer = I(d)), 3 === o.options.probeType && o.trigger("scroll", {
                            x: o.x,
                            y: o.y
                        })
                    }()
                ...
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
                    n = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : D.bounce;
                (this.x !== t || this.y !== e) && (this.isInTransition = this.options.useTransition && 0 < i && (t !== this.x || e !== this.y), !i || this.options.useTransition ? (this._transitionTimingFunction(n.style), this._transitionTime(i), this._translate(t, e), i && 3 === this.options.probeType && this._startProbe(), i || (this.trigger("scroll", {
                    x: t,
                    y: e
                ...
                function n() {
                    this.off(t, n), e.apply(i, arguments)
                }
                n.fn = e, this.on(t, n)
            }, L.prototype.off = function(e, i) {
                var n = this._events[e];
                if (n)
                    for (var o = n.length; o--;)(n[o][0] === i || n[o][0] && n[o][0].fn === i) && t(n, o)
            }, L.prototype.trigger = function(t) {
                var i = this._events[t];
                if (i)
                    for (var n = i.length, o = [].concat(function(t) {
                            if (Array.isArray(t)) {
                ...
                t.wheelWrapperClass || (t.wheelWrapperClass = "wheel-scroll"), t.wheelItemClass || (t.wheelItemClass = "wheel-item"), void 0 === t.selectedIndex && (t.selectedIndex = 0, A("wheel option selectedIndex is required!"))
            }, H.Version = "1.14.1", H
